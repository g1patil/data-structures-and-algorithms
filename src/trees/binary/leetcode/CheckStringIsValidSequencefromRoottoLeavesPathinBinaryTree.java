...
public class CheckStringIsValidSequencefromRoottoLeavesPathinBinaryTree {
    ...
    public boolean isValidSequence(TreeNode root, int[] arr) {
        ...
        return isValidSequenceHelper(root , String.valueOf(root.val) , sb.toString() );
    }
    ...
    private boolean isValidSequenceHelper(TreeNode root, String s, String expected) {
        ...
        return isValidSequenceHelper(root.left , s + String.valueOf(s) , expected) ||
         isValidSequenceHelper(root.right , s + String.valueOf(s) , expected) ;
    }
